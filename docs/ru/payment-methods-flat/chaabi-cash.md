...
| Конечная точка | `/v2/payment/wallet/chaabi/sale` |
...
| {     "type": "add_info",     "title": "bank_name",     "data": "Chaabi Cash" } | `Chaabi Cash`Пример:Название банка получателя. |
...
| --- | --- |
| Формат тела запроса | JSON |
| Конечная точка | `/v2/payment/wallet/chaabi/payout` |
| Полная спецификация конечной точки |  |
...
## Chaabi Cash -Оплата 2: с отображением реквизитов
...
## Chaabi Cash -Оплата 1: перенаправление в сервис провайдера
