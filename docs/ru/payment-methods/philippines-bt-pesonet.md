...
| Конечная точка | `/v2/payment/bank-transfer/pesonet/sale` |
...
## Bank transfers in the Philippines через PESONet -Оплата
...
| **Особенности**Время проведения оплаты варьируется в зависимости от времени, когда пользователь совершает оплату. Оплата, совершенная пользователем до 15:00, проводится в 15:00 этого же дня. Оплата, совершенная пользователем после 15:00, проводится в 15:00 следующего дня. Время указано для зоны UTC+8.ru_gate_amount_modification.ditaЕсли пользователь при оплате укажет сумму, отличную от суммы, указанной в запросе на оплату, то платеж будет проводиться с особенностями, которые описаны в разделе. Для получения более подробной информации обратитесь к своему курирующему менеджеру Some Platform. |  |
