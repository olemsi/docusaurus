...
Use this page if you need the Belgium-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in Belgium lets the customer pay from a Belgian bank account in EUR through the bank or provider flow instead of entering card data.
...
- the Belgium Open Banking method is enabled for your project
...
Belgium Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/belgium/sale/list
```
