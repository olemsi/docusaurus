...
Use this page if you need the Greece-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in Greece lets the customer pay from a Greek bank account in EUR through the bank or provider flow instead of entering card data.
...
- the Greece Open Banking method is enabled for your project
...
Greece Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/greece/sale/list
```
