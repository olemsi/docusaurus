...
Use this page if you need the Latvia-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in Latvia lets the customer pay from a Latvian bank account in EUR through the bank or provider flow instead of entering card data.
...
- the Latvia Open Banking method is enabled for your project
...
Latvia Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/latvia/sale/list
```
