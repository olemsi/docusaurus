...
Use this page if you need the Hungary-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in Hungary lets the customer pay from a Hungarian bank account in HUF through the bank or provider flow instead of entering card data.
...
- the Hungary Open Banking method is enabled for your project
- your project can process `HUF` payments with this method
...
Hungary Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/hungary/sale/list
```
