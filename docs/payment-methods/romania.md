...
Use this page if you need the Romania-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in Romania lets the customer pay from a Romanian bank account in RON through the bank or provider flow instead of entering card data.
...
- the Romania Open Banking method is enabled for your project
- your project can process `RON` payments with this method
...
Romania Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/romania/sale/list
```
