...
| addresstype_string type_strictly_required | `1 Main Street`Пример:Адрес пользователя. |  |
| citytype_string type_strictly_required | `London`Пример:Город пользователя. |  |
| countrytype_string type_strictly_required | `GB`Пример:Страна пользователя в формате ISO 3166-1 alpha-2. |  |
| ziptype_string type_strictly_required | `123456`Пример:Почтовый индекс пользователя. |  |
...
| by_methodtype_string type_strictly_required | `paysafecard``paysafecard`Пример:Код платежного метода (его значение всегда). |  |
...
| customer_phonetype_string type_strictly_required | `12345678901`Пример:Номер телефона пользователя. |
...
| customer_countrytype_string type_strictly_required | `GB`Пример:Страна пользователя в формате ISO 3166-1 alpha-2. |
| customer_citytype_string type_strictly_required | `London`Пример:Город пользователя. |
| customer_ziptype_string type_strictly_required | `123456`Пример:Почтовый индекс пользователя. |
| customer_addresstype_string type_strictly_required | `1 Main Street`Пример:Адрес пользователя. |
...
| **Регионы использования** | country_AS, country_AT, country_BE, country_CA, country_CH, country_CY, country_CZ, country_DE, country_DK, country_ES, country_FI, country_FR, country_GB, country_GU, country_HR, country_HU, country_IE, country_IT, country_LU, country_LV, country_MP, country_MT, country_MX, country_NL, country_NO, country_PL, country_PR, country_PT, country_RO, country_SE, country_SI, country_SK, country_TR, country_US, country_VI |
| --- | --- |
