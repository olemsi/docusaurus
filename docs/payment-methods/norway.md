...
Use this page if you need the Norway-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in Norway lets the customer pay from a Norwegian bank account in NOK through the bank or provider flow instead of entering card data.
...
- the Norway Open Banking method is enabled for your project
- your project can process `NOK` payments with this method
...
Norway Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/norway/sale/list
```
