...
| Конечная точка | `/v2/payment/voucher/fawry/sale` |
...
| accounttype_object type_strictly_required | numbertype_string type_strictly_required | `12345678910`Пример:Номер телефона пользователя, на который зарегистрирован аккаунт (указывается с кодом страны и без знака +). |
...
| customer_account_numbertype_string type_required | `12345678910`Пример:Номер телефона пользователя, на который зарегистрирован аккаунт (указывается с кодом страны и без знака +). |
