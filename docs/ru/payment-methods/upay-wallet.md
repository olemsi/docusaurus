...
| Конечная точка | `/v2/payment/wallet/upay/sale` |
...
| --- | --- |
| Формат тела запроса | JSON |
| Конечная точка | `/v2/payment/wallet/upay/payout` |
| Полная спецификация конечной точки |  |
