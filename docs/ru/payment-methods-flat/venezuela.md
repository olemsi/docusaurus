...
| Конечная точка | `/v2/payment/banks/venezuela-mobile-banking/sale` |
...
|  | Интерфейсы | references/ru/currencies/VES.ditaСумма платежа, | Время проведения платежа |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Payment Widget | Gate | Dashboard | минимум | максимум | базовое | предельное |  |
| Оплата |  |  |  | 5,00 |  | 1-2 минуты | 1 час 30 минут |
...
| **Особенности**Время проведения платежа ограничено. Если пользователь не выполнит необходимые для оплаты действия в течение 1 часа после перенаправления в сервис provider_service, то платеж отклоняется.references/ru/currencies/VES.ditaСумма платежа в валютедолжна быть целочисленной.references/ru/currencies/VES.ditaru_currency_codes.ditaСумму в запросе указывайте в дробных единицах валюты! Например, сумма 95,00в запросе представляется как 9500. Число дробных единиц для различных валют можно узнать в разделе.references/ru/currencies/VES.ditaПри указании в запросах других валют сумма платежа конвертируется вна стороне Some Platform. |  |
...
|  | Интерфейсы | references/ru/currencies/VES.ditaСумма платежа, | Базовое время проведения платежа |  |  |  |
| --- | --- | --- | --- | --- | --- | --- |
| Payment Widget | Gate | Dashboard | минимум | максимум |  |  |
| Оплата |  |  |  | 5,00 |  | 1-2 минуты |
...
| title — это платежный метод, который позволит вам принимать оплату от пользователей, а также выплачивать пользователям денежные средства.Платежный метод title позволяет принимать от пользователей оплату, используя Payment Widget и Gate.здесьЗагрузить логотип этого платежного метода в векторном формате можно. |  |
| --- | --- |
