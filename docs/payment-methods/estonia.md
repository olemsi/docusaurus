...
Use this page if you need the Estonia-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in Estonia lets the customer pay from an Estonian bank account in EUR through the bank or provider flow instead of entering card data.
...
- the Estonia Open Banking method is enabled for your project
...
Estonia Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/estonia/sale/list
```
