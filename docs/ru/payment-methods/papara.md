...
| Конечная точка | `/v2/payment/wallet/papara/sale` |
...
| day_of_birthtype_strictly_required✱type_string | `12-12-1990`Пример:Дата рождения пользователя в формате ДД-ММ-ГГГГ. |  |
| countrytype_strictly_required✱type_string | `TR`Пример:Страна пользователя в формате ISO 3166-1 alpha-2. |  |
...
| {     "type": "add_info",     "title": "receiver_account",     "data": "TR123456789012345" } | `TR123456789012345`Пример:Номер аккаунта получателя платежа в сервисе title. |
...
| --- | --- |
| Формат тела запроса | JSON |
| Конечная точка | `/v2/payment/wallet/papara/payout` |
| Полная спецификация конечной точки |  |
...
| --- | --- |
| **Валюты выплаты** | references/ru/currencies/TRY.dita |
...
| customer_countrytype_strictly_required✱type_string | `TR`Пример:Страна пользователя в формате ISO 3166-1 alpha-2. |
| customer_day_of_birthtype_strictly_required✱type_string | `12-12-1990`Пример:Дата рождения пользователя в формате ДД-ММ-ГГГГ. |
...
## Papara -Оплата 2: с отображением реквизитов
...
## Papara -Оплата 1: перенаправление в сервис провайдера
