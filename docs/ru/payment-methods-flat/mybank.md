...
| Конечная точка | `/v2/payment/banks/mybank/sale` |
...
| --- | --- |
| Формат тела запроса | JSON |
| Конечная точка | `/v2/payment/banks/mybank/refund` |
| Полная спецификация конечной точки |  |
...
| **Регионы использования** | country_BE, country_ES, country_IT, country_PT |
| --- | --- |
