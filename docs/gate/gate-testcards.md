...
, such as payment amount, cardholder name, or verification code,For example, the card expiry date cannot predate the payment date.With test cards, the processing scenario is selected based on the card number. Other parameterscan take arbitrary values, but they must be specified in the correct format.
...
| `5126 1600 0035 6675` | Mastercard | `success` | Payment with partial authorisation was approved (if this capability is enabled and the purchase amount in the request is greater than 120 EUR, details) |
| `4010 5716 7622 3548` | Visa | `success` | Payment with partial authorisation was approved (if this capability is enabled and the purchase amount in the request is greater than 120 EUR, details) |

| Card | Status | Notes |
| --- | --- | --- |
| `5586 2001 0437 743411/25641`Number:Expiration date:CVC (CVV): | `success` | – |
| `4058 7032 1169 885911/25769`Number:Expiration date:CVC (CVV): | `success` | – |

| Card | Status | Notes |
| --- | --- | --- |
| `5586 2000 7526 970111/25641`Number:Expiration date:CVC (CVV): | ```success``decline` | `123456`The valid confirmation code to perform the 3‑D Secure authentication is. When any other confirmation codes are entered, payments are declined |
| `4058 7032 1169 826311/25769`Number:Expiration date:CVC (CVV): | ```success``decline` | `123456`The valid confirmation code to perform the 3‑D Secure authentication is. When any other confirmation codes are entered, payments are declined |
...
| Card | Status | Notes |
| --- | --- | --- |
| `2201 3820 0000 001312/25590`Number:Expiration date:CVC (CVV): | `success` | – |
| `2201 3820 0000 002112/25487`Number:Expiration date:CVC (CVV): | `decline` | – |
| `2201 3820 0000 003912/25324`Number:Expiration date:CVC (CVV): | `success` | `1qwezxc`Challenge flow when the ACS page is displayed for entering the code. The valid confirmation code is. When any other confirmation codes are entered, payments are declined |
| `2201 3820 0000 004712/25584`Number:Expiration date:CVC (CVV): | `success` | `1qwezxc`Challenge flow when the ACS page is displayed for entering the code. The valid confirmation code is. When any other confirmation codes are entered, payments are declined |
...
To process test payouts you can use the test payment cards presented in the following table, as well as any other cards for testing of declined payouts.
...
| `5413 3300 0000 0019` | Mastercard | `success` |
| `5413 3300 0000 0035` | Mastercard | `decline` |
| `2200 5104 1777 0601` | Mir | `success` |
| `2201 4120 0000 0000` | Mir | `decline` |

| Card | Status |
| --- | --- |
| `5586 2001 0437 7434`Number:Expiration date: 11/25 | `success` |
| `5586 2000 7526 9701`Number:Expiration date: 11/25 | `success` |
| `4058 7032 1169 8859`Number:Expiration date: 11/25 | `success` |
| `4058 7032 1169 8263`Number:Expiration date: 11/25 | `success` |
| `2201 3820 0000 0013`Number:Expiration date: 12/25 | `success` |
| `2201 3820 0000 0021`Number:Expiration date: 12/25 | `success` |
| `2201 3820 0000 0039`Number:Expiration date: 12/25 | `success` |
| `2201 3820 0000 0047`Number:Expiration date: 12/25 | `success` |
