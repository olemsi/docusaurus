...
$(document).ready(function () {
    ...
    // отключено т.к. структура меню обновлена и уже не имеет отношения к wh
...
function localHref() {
    ...
    var translatedPage = !currentPage.match(/search/) ? currentPage.replace(/\/ru\/ru_/g, '/en/en_') : currentPage.replace(/\/ru\//g, '/en/');
    $('.lang-switch .lang-switch__dropdown a').attr('href', translatedPage);
}