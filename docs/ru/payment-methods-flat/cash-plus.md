...
| Конечная точка | `/v2/payment/wallet/cashplus/sale` |
...
| {     "type": "add_info",     "title": "bank_name",     "data": "Cashplus" } | `Cashplus`Пример:Название банка получателя. |
...
| --- | --- |
| Формат тела запроса | JSON |
| Конечная точка | `/v2/payment/wallet/cashplus/payout` |
| Полная спецификация конечной точки |  |
...
## Cash Plus -Оплата 2: с отображением реквизитов
...
## Cash Plus -Оплата 1: перенаправление в сервис провайдера
