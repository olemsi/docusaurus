...
| Конечная точка | `/v2/payment/wallet/jibi/sale` |
...
| {     "type": "add_info",     "title": "bank_name",     "data": "Jibi" } | `Jibi`Пример:Название банка получателя. |
...
| --- | --- |
| Формат тела запроса | JSON |
| Конечная точка | `/v2/payment/wallet/jibi/payout` |
| Полная спецификация конечной точки |  |
...
## Jibi -Оплата 2: с отображением реквизитов
...
## Jibi -Оплата 1: перенаправление в сервис провайдера
