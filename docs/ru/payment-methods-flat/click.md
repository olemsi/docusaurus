...
2. Отобразите пользователю QR-код и платежные реквизиты.
...
| {     "type": "add_info",     "title": "receiver_account",     "data": "998932145678" } | `998932145678`Пример:Номер телефона получателя перевода. |
| {     "type": "add_info",     "title": "qr_data",     "data": "https://example.uz/qr" } | `https://example.uz/qr`Пример:Ссылка, по которой отображается QR-код. |
| {     "type": "add_info",     "title": "lifetime",     "data": "600" } | `600`Пример:Срок действия реквизитов в секундах. |
| {     "type": "add_info",     "title": "bank_name",     "data": "Example Bank" } | `Example Bank`Пример:Название банка получателя. |
...
При оплате 
пользователь следует шагам платежной инструкции, отображаемой на странице оплаты или в вашей системе (при работе через Gate), и совершает перевод по реквизитам или сканирует QR-код.
...
оплатеПрипользователь следует шагам платежной инструкции, отображаемой на странице оплаты или в вашей системе (при работе через Gate), и совершает перевод по реквизитам или сканирует QR-код.
