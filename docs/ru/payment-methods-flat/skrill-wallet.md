...
| Конечная точка | `/v2/payment/wallet/skrill/sale` |
...
| phonetype_required✱type_string | `12345678901`Пример:Номер телефона пользователя. |  |
...
| customer_phonetype_required✱type_string | `12345678901`Пример:Номер телефона пользователя. |
...
| **Регионы использования** | EU, EEA, UK |
| --- | --- |
