...
| Конечная точка | `/v2/payment/wallet/ipay/sale` |
...
| --- | --- |
| Формат тела запроса | JSON |
| Конечная точка | `/v2/payment/wallet/ipay/payout` |
| Полная спецификация конечной точки |  |
