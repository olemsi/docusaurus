...
Use this page if you need the France-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in France lets the customer pay from a French bank account in EUR through the bank or provider flow instead of entering card data.
...
- the France Open Banking method is enabled for your project
...
France Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/france/sale/list
```
