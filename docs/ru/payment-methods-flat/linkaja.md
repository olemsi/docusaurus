...
| Конечная точка | `/v2/payment/wallet/linkaja/sale` |
...
ru_pm_linkaja_gate_purchase_redirect.ditaПодробная информация о проведении оплаты с использованием метода title через Gate представлена в разделе.
...
| --- | --- |
| Формат тела запроса | JSON |
| Конечная точка | `/v2/payment/wallet/linkaja/payout` |
| Полная спецификация конечной точки |  |
...
ru_pm_linkaja_pp_purchase_redirect.ditaПодробная информация о проведении оплаты с использованием метода title через Payment Widget представлена в разделе.
...
| **Возврат** |  |
| **Организация и стоимость подключения** | По согласованию с курирующим менеджером Some Platform |
| **Особенности**Оплата может проводиться только через мобильное приложение title. При попытке оплатить не с мобильных устройств пользователю будет предложено перейти в мобильное приложение title после выполнения необходимых действий |  |
