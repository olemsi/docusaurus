...
Use this page if you need the UK-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in the UK lets the customer pay from a UK bank account in GBP through the bank or provider flow instead of entering card data.
...
- the UK Open Banking method is enabled for your project
- your project can process `GBP` payments with this method
...
The UK Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/uk/sale/list
```
