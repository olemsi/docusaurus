...
| Конечная точка | `/v2/payment/wallet/duitnow/sale` |
...
ru_pm_duitnow_gate_purchase_redirect.ditaПодробная информация о проведении оплаты с использованием метода title через Gate представлена в разделе.
...
ru_pm_duitnow_pp_purchase_redirect.ditaПодробная информация о проведении оплаты с использованием метода title через Payment Widget представлена в разделе.
...
::: tip
Актуальность этих особенностей уточняйте у курирующего менеджера Some Platform.
:::
