...
| Online Debit — интернет-банкинг | 100,00 | 1&#160;000&#160;000,00 | 100,00 | Для InstaPay — 50&#160;000,00 Для PESONet — 1&#160;686&#160;000,00 |
...
| Virtual Accounts — банковские переводы | 100,00 | 1&#160;686&#160;000,00 | 100,00 | Для InstaPay — 50&#160;000,00 Для PESONet — 838&#160;147,50 |
...
- references/ru/currencies/PHP.dita20&#160;000,00&#160;— сумма, которая была указана в запросе на проведение платежа;references/ru/currencies/PHP.ditareferences/ru/currencies/PHP.dita19&#160;999,86&#160;— сумма, которая отображается пользователю на стороне сервиса провайдера. Пользователь должен выполнить оплату с указанием этой суммы, при этом мерчанту будет зачислена первоначальная сумма платежа (20&#160;000,00&#160;).При проведении оплаты с использованием методовQR Ph и GoTyme из-за особенностей работы провайдера сумма платежа, указанная в инструкции на стороне сервиса провайдера, незначительно отличается от суммы в запросе на проведение платежа. Пользователь должен произвести оплату согласно платежной инструкции, при этом мерчанту зачисляется полная сумма, указанная в платежной инструкции, например:
- references/ru/currencies/PHP.ditaВ платежных методах QR Ph и GoTyme, если пользователь выполнит оплату с указанием иной суммы, например укажет первоначальную сумму платежа (20 000,00), проведение платежа приостанавливается, пока конфликт не будет разрешен вручную техническими специалистами Some Platform.
