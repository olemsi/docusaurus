...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en","dir":"ltr","title":"Platform Docs","description":"Platform payment platform integration guides and API reference","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":"force-dark","themeConfig":{"logo":"/logo.svg","siteTitle":"Platform Docs","nav":[{"text":"Host-to-host API","link":"/gate/"},{"text":"Payment Widget","link":"/payment-page/"},{"text":"Payment Methods","link":"/payment-methods/"},{"text":"Dashboard","link":"/dashboard/"},{"text":"API Reference","items":[{"text":"Host-to-host API","link":"/api-reference/gate.html","target":"_self"},{"text":"Data API","link":"/api-reference/data.html","target":"_self"}]}],"sidebar":{"/gate/":[{"text":"Overview","link":"/gate/"},{"text":"Getting started","collapsed":true,"items":[{"text":"Section map","link":"/gate/gate-integration-about"},{"text":"Integration overview","link":"/gate/gate-how-to-integrate"},{"text":"Quickstart","link":"/gate/gate-quickstart"},{"text":"Basic implementation","link":"/gate/gate-quickstart-basic-implementation"}]},{"text":"Payment flows","collapsed":true,"items":[{"text":"One-time purchases","link":"/gate/gate-purchase"},{"text":"Payment link purchases","link":"/gate/gate-invoice"},{"text":"COF purchases","link":"/gate/gate--payments-on-saved-data"},{"text":"Purchase refunds","link":"/gate/gate-refund"},{"text":"Payouts","link":"/gate/gate-payout"},{"text":"Payment verification","link":"/gate/gate-account-verification"}]},{"text":"Procedures and tools","collapsed":true,"items":[{"text":"Auxiliary procedures","link":"/gate/gate-procedures"},{"text":"Additional capabilities","link":"/gate/gate"}]},{"text":"Technical reference","collapsed":true,"items":[{"text":"API Description","link":"/gate/gate-sts-protocol"},{"text":"Request format","link":"/gate/gate-requests-format"},{"text":"Signature generation","link":"/gate/signature-gate"},{"text":"Test cards","link":"/gate/gate-testcards"}]},{"text":"API Reference ↗","link":"/api-reference/gate.html"}],"/payment-page/":[{"text":"Overview","link":"/payment-page/"},{"text":"Quickstart","collapsed":true,"items":[{"text":"Quickstart","link":"/payment-page/pp-quickstart-overview"},{"text":"Signature generation","link":"/payment-page/pp-signature-generation"},{"text":"Basic implementation","link":"/payment-page/pp-quickstart-basic-implementation"},{"text":"Callback handling","link":"/payment-page/pp-interaction"}]},{"text":"Integration guides","collapsed":true,"items":[{"text":"Section map","link":"/payment-page/pp-about"},{"text":"Integration overview","link":"/payment-page/pp-interaction-organisation-overview"},{"text":"Interaction model","link":"/payment-page/pp-general-interaction"},{"text":"UX overview","link":"/payment-page/pp-ux-configuration"},{"text":"Open in new tab","link":"/payment-page/pp-opening-html-overview"},{"text":"Open in modal","link":"/payment-page/pp-opening-modal-via-javascript-library"},{"text":"Open in iframe","link":"/payment-page/pp-opening-iframe-via-javascript-library"}]},{"text":"Payment scenarios","collapsed":true,"items":[{"text":"Scenario overview","link":"/payment-page/pp-basic-actions"},{"text":"Purchase processing","link":"/payment-page/pp-purchase"},{"text":"Authorisation hold","link":"/payment-page/pp-purchase-auth"},{"text":"COF purchase registration","link":"/payment-page/pp-recurring"},{"text":"Payment verification","link":"/payment-page/pp-account-verification"},{"text":"Tokenization","link":"/payment-page/pp-token"}]},{"text":"Additional capabilities","collapsed":true,"items":[{"text":"Overview","link":"/payment-page/pp"},{"text":"3-D Secure","link":"/payment-page/pp-3ds"},{"text":"AVS","link":"/payment-page/pp-avs"},{"text":"Additional payment info","link":"/payment-page/pp-clarification"},{"text":"Currency conversion","link":"/payment-page/pp-conversion"},{"text":"Collecting customer data","link":"/payment-page/pp-gathering-customer-data"},{"text":"Time limit","link":"/payment-page/pp-time-limit"},{"text":"UI event handling","link":"/payment-page/pp-ui-monitoring"}]},{"text":"Customisation","collapsed":true,"items":[{"text":"Overview","link":"/payment-page/pp--design-customisation"},{"text":"Design overview","link":"/payment-page/pp-design-overview"},{"text":"Design requirements","link":"/payment-page/pp--design-requirements"}]},{"text":"Technical reference","collapsed":true,"items":[{"text":"API Description","link":"/payment-page/pp-api"},{"text":"Parameters","link":"/payment-page/pp-parameters"},{"text":"Data formats","link":"/payment-page/pp-formats"},{"text":"Test cards","link":"/payment-page/pp-testcards"}]}],"/payment-methods/":[{"text":"Payment Methods","link":"/payment-methods/"},{"text":"Open Banking","link":"/payment-methods/openbanking"},{"text":"Open Banking by country","collapsed":true,"items":[{"text":"Open Banking in Austria","link":"/payment-methods/austria"},{"text":"Open Banking in Belgium","link":"/payment-methods/belgium"},{"text":"Open Banking in Estonia","link":"/payment-methods/estonia"},{"text":"Open Banking in Finland","link":"/payment-methods/finland"},{"text":"Open Banking in France","link":"/payment-methods/france"},{"text":"Open Banking in Germany","link":"/payment-methods/germany"},{"text":"Open Banking in Greece","link":"/payment-methods/greece"},{"text":"Open Banking in Hungary","link":"/payment-methods/hungary"},{"text":"Open Banking in Latvia","link":"/payment-methods/latvia"},{"text":"Open Banking in Lithuania","link":"/payment-methods/lithuania"},{"text":"Open Banking in the Netherlands","link":"/payment-methods/netherlands"},{"text":"Open Banking in Norway","link":"/payment-methods/norway"},{"text":"Open Banking in Poland","link":"/payment-methods/poland"},{"text":"Open Banking in Portugal","link":"/payment-methods/portugal"},{"text":"Open Banking in Romania","link":"/payment-methods/romania"},{"text":"Open Banking in Spain","link":"/payment-methods/spain"},{"text":"Open Banking in Sweden","link":"/payment-methods/sweden"},{"text":"Open Banking in the UK","link":"/payment-methods/uk"}]}],"/dashboard/":[{"text":"Overview","link":"/dashboard/"},{"text":"Getting started","collapsed":true,"items":[{"text":"Section map","link":"/dashboard/dbl-about"},{"text":"Capabilities and roles","link":"/dashboard/dbl-roles-overview"},{"text":"User interface","link":"/dashboard/dbl-interface-overview"},{"text":"Managing projects","link":"/dashboard/dbl-projects"}]},{"text":"Operations","collapsed":true,"items":[{"text":"Payments","link":"/dashboard/dbl-payments-overview"},{"text":"Balances","link":"/dashboard/dbl-balances-overview"},{"text":"Risk management","link":"/dashboard/dbl-fraud-operations-control-overview"}]},{"text":"Programmatic access","collapsed":true,"items":[{"text":"Using Data API","link":"/dashboard/dbl-api-protocol"}]}]},"socialLinks":[],"footer":{"message":"Platform — payment platform documentation","copyright":"© 2026 Platform"},"search":{"provider":"local"},"outline":{"level":[2,3]}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const VPBackdrop = /* @__PURE__ */ _export_sfc(_sfc_main$17, [["__scopeId", "data-v-54a304ca"]]);
...
const NotFound = /* @__PURE__ */ _export_sfc(_sfc_main$16, [["__scopeId", "data-v-6ff51ddd"]]);
...
const VPDocOutlineItem = /* @__PURE__ */ _export_sfc(_sfc_main$15, [["__scopeId", "data-v-53c99d69"]]);
...
const VPDocAsideOutline = /* @__PURE__ */ _export_sfc(_sfc_main$14, [["__scopeId", "data-v-f610f197"]]);
...
const VPDocAside = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["__scopeId", "data-v-cb998dce"]]);
...
const VPDocFooterLastUpdated = /* @__PURE__ */ _export_sfc(_sfc_main$10, [["__scopeId", "data-v-1bb0c8a8"]]);
...
const VPDocFooter = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["__scopeId", "data-v-1bcd8184"]]);
...
const VPDoc = /* @__PURE__ */ _export_sfc(_sfc_main$_, [["__scopeId", "data-v-e6f2a212"]]);
...
const VPButton = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["__scopeId", "data-v-93dc4167"]]);
...
const VPImage = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [["__scopeId", "data-v-ab19afbb"]]);
...
const VPHero = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["__scopeId", "data-v-dd8814ff"]]);
...
const VPFeature = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["__scopeId", "data-v-bd37d1a2"]]);
...
const VPFeatures = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["__scopeId", "data-v-b1eea84a"]]);
...
const VPHomeContent = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["__scopeId", "data-v-c141a4bd"]]);
...
const VPHome = /* @__PURE__ */ _export_sfc(_sfc_main$R, [["__scopeId", "data-v-e07eaea7"]]);
const _sfc_main$Q = {};
...
const VPContent = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["__scopeId", "data-v-9a6c75ad"]]);
...
const VPFooter = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["__scopeId", "data-v-566314d4"]]);
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["__scopeId", "data-v-6b867909"]]);
...
const VPLocalNav = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["__scopeId", "data-v-2488c25a"]]);
function useNav() {
...
const VPSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-b4ccac88"]]);
...
const VPSwitchAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["__scopeId", "data-v-be9742d9"]]);
...
const VPNavBarAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["__scopeId", "data-v-3f90c1a5"]]);
...
const VPMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["__scopeId", "data-v-7eeeb2dc"]]);
...
const VPMenu = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["__scopeId", "data-v-20ed86d6"]]);
...
const VPFlyout = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["__scopeId", "data-v-bfe7971f"]]);
...
const VPSocialLink = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["__scopeId", "data-v-60a9a2d3"]]);
...
const VPNavBarExtra = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["__scopeId", "data-v-f953d92f"]]);
...
const VPNavBarMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["__scopeId", "data-v-815115f5"]]);
const _sfc_main$z = /* @__PURE__ */ defineComponent({
...
const VPNavBarMenu = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["__scopeId", "data-v-afb2845e"]]);
...
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.BgtcGwDp.js"));
...
const VPNavBarTitle = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["__scopeId", "data-v-9f43907a"]]);
const _sfc_main$t = /* @__PURE__ */ defineComponent({
...
const VPNavBarTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["__scopeId", "data-v-acee064b"]]);
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  __name: "VPNavBar",
  __ssrInlineRender: true,
  props: {
...
const VPNavBar = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["__scopeId", "data-v-9fd4d1dd"]]);
const _sfc_main$r = /* @__PURE__ */ defineComponent({
...
const VPNavScreenAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["__scopeId", "data-v-a3e2920d"]]);
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["__scopeId", "data-v-fa963d97"]]);
const _sfc_main$p = /* @__PURE__ */ defineComponent({
...
const VPNavScreenMenuGroupLink = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["__scopeId", "data-v-e04f3e85"]]);
const _sfc_main$o = /* @__PURE__ */ defineComponent({
...
const VPNavScreenMenuGroupSection = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["__scopeId", "data-v-f60dbfa7"]]);
const _sfc_main$n = /* @__PURE__ */ defineComponent({
...
const VPNavScreenMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["__scopeId", "data-v-d99bfeec"]]);
const _sfc_main$m = /* @__PURE__ */ defineComponent({
...
const VPNavScreenTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["__scopeId", "data-v-516e4bc3"]]);
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  __name: "VPNavScreen",
  __ssrInlineRender: true,
  props: {
...
const VPNavScreen = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["__scopeId", "data-v-2dd6d0c7"]]);
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  __name: "VPNav",
  __ssrInlineRender: true,
  setup(__props) {
...
const VPNav = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["__scopeId", "data-v-7ad780c2"]]);
const _sfc_main$h = /* @__PURE__ */ defineComponent({
...
const VPSidebarItem = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["__scopeId", "data-v-0009425e"]]);
const _sfc_main$g = /* @__PURE__ */ defineComponent({
...
const VPSidebarGroup = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["__scopeId", "data-v-51288d80"]]);
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  __name: "VPSidebar",
  __ssrInlineRender: true,
  props: {
...
const VPSidebar = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-42c4c606"]]);
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  __name: "VPSkipLink",
  __ssrInlineRender: true,
  setup(__props) {
...
const VPSkipLink = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-fcbfc0e0"]]);
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  __name: "Layout",
  __ssrInlineRender: true,
  setup(__props) {
...
const Layout = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-d8b57b2d"]]);
const GridSettings = {
  xmini: [[0, 2]],
  mini: [],
  small: [
...
const VPTeamMembersItem = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-acff304e"]]);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const toast = ref("");
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ask-ai" }, _attrs))} data-v-281eefa9><button class="ask-ai-btn" data-v-281eefa9> ✨ Ask AI <span class="${ssrRenderClass([{ open: isOpen.value }, "ask-ai-caret"])}" data-v-281eefa9>▾</span></button>`);
      if (isOpen.value) {
        _push(`<div class="ask-ai-menu" data-v-281eefa9><div class="ask-ai-section" data-v-281eefa9>Last Used</div><button class="ask-ai-item" data-v-281eefa9><span class="ask-ai-item-icon" data-v-281eefa9>❋</span> Claude <span class="ask-ai-external" data-v-281eefa9>↗</span></button><button class="ask-ai-item" data-v-281eefa9><span class="ask-ai-item-icon" data-v-281eefa9>◎</span> ChatGPT <span class="ask-ai-external" data-v-281eefa9>↗</span></button><div class="ask-ai-divider" data-v-281eefa9></div><button class="ask-ai-item" data-v-281eefa9><span class="ask-ai-item-icon" data-v-281eefa9>📋</span> ${ssrInterpolate(copied.value ? "Copied!" : "Copy Markdown")}</button><button class="ask-ai-item" data-v-281eefa9><span class="ask-ai-item-icon" data-v-281eefa9>📄</span> View as Markdown </button></div>`);
      } else {
        _push(`<!---->`);
      }
      if (toast.value) {
        _push(`<div class="ask-ai-toast" data-v-281eefa9>${ssrInterpolate(toast.value)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/AiChat.vue");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["home", { visible: visible.value }]
      }, _attrs))} data-v-cbf32cab><nav class="home-nav" data-v-cbf32cab><div class="nav-inner" data-v-cbf32cab><a href="/" class="nav-logo" data-v-cbf32cab>Platform Docs</a><div class="nav-links" data-v-cbf32cab><a href="/gate/" data-v-cbf32cab>Host-to-host API</a><a href="/payment-page/" data-v-cbf32cab>Payment Widget</a><a href="/payment-methods/" data-v-cbf32cab>Payment Methods</a><a href="/dashboard/" data-v-cbf32cab>Dashboard</a><a href="/api-reference/gate.html" class="nav-api" data-v-cbf32cab>API Reference</a></div></div></nav><section class="hero" data-v-cbf32cab><div class="hero-orb hero-orb-a" data-v-cbf32cab></div><div class="hero-orb hero-orb-b" data-v-cbf32cab></div><div class="hero-grid" data-v-cbf32cab></div><div class="hero-shell" data-v-cbf32cab><div class="hero-copy" data-v-cbf32cab><div class="hero-badge" data-v-cbf32cab>Platform developer docs</div><h1 class="hero-title" data-v-cbf32cab> Integrate payments with the <span class="hero-accent" data-v-cbf32cab>right entry point</span></h1><p class="hero-desc" data-v-cbf32cab> Choose hosted checkout or server-to-server integration, then follow the matching quickstart. </p></div><div class="hero-panel" data-v-cbf32cab><div class="panel-heading" data-v-cbf32cab>Recommended start</div><div class="panel-stack" data-v-cbf32cab><a href="/payment-page/pp-quickstart-overview" class="panel-row panel-row-primary" data-v-cbf32cab><div data-v-cbf32cab><div class="panel-kicker" data-v-cbf32cab>Recommended for most merchants</div><div class="panel-title" data-v-cbf32cab>Payment Widget quickstart</div></div><span data-v-cbf32cab>Open</span></a></div><div class="panel-meta" data-v-cbf32cab><span data-v-cbf32cab>Need backend control instead?</span><div class="panel-links" data-v-cbf32cab><a href="/gate/gate-quickstart" data-v-cbf32cab>Host-to-host API quickstart</a><a href="/gate/signature-gate" data-v-cbf32cab>Signature guide</a><a href="/api-reference/gate.html" data-v-cbf32cab>API reference</a></div></div></div></div></section><section class="paths" data-v-cbf32cab><div class="section-head" data-v-cbf32cab><h2 data-v-cbf32cab>Pick the integration model first</h2></div><div class="paths-grid" data-v-cbf32cab><!--[-->`);
      ssrRenderList(mainPaths, (path) => {
        _push(`<a${ssrRenderAttr("href", path.link)} class="path-card" data-v-cbf32cab><div class="path-top" data-v-cbf32cab><span class="path-label" data-v-cbf32cab>${ssrInterpolate(path.label)}</span><span class="path-tag" data-v-cbf32cab>${ssrInterpolate(path.tag)}</span></div><h3 data-v-cbf32cab>${ssrInterpolate(path.title)}</h3><p data-v-cbf32cab>${ssrInterpolate(path.description)}</p><ul data-v-cbf32cab><!--[-->`);
        ssrRenderList(path.bullets, (bullet) => {
          _push(`<li data-v-cbf32cab>${ssrInterpolate(bullet)}</li>`);
        });
        _push(`<!--]--></ul><span class="path-link" data-v-cbf32cab>Explore</span></a>`);
      });
      _push(`<!--]--></div><div class="secondary-grid" data-v-cbf32cab><!--[-->`);
      ssrRenderList(secondaryPaths, (item) => {
        _push(`<a${ssrRenderAttr("href", item.link)} class="secondary-card" data-v-cbf32cab><h3 data-v-cbf32cab>${ssrInterpolate(item.title)}</h3><p data-v-cbf32cab>${ssrInterpolate(item.desc)}</p></a>`);
      });
      _push(`<!--]--></div></section><section class="proof" data-v-cbf32cab><div class="section-head" data-v-cbf32cab><p class="eyebrow" data-v-cbf32cab>What you get</p><h2 data-v-cbf32cab>Docs for implementation, reference, and live operations</h2></div><div class="proof-grid" data-v-cbf32cab><!--[-->`);
      ssrRenderList(trustPoints, (item) => {
        _push(`<div class="proof-card" data-v-cbf32cab><div class="proof-value" data-v-cbf32cab>${ssrInterpolate(item.value)}</div><p data-v-cbf32cab>${ssrInterpolate(item.text)}</p></div>`);
      });
      _push(`<!--]--></div></section><section class="links" data-v-cbf32cab><div class="section-head" data-v-cbf32cab><p class="eyebrow" data-v-cbf32cab>Jump directly</p><h2 data-v-cbf32cab>Open the page that matches the question</h2></div><div class="links-grid" data-v-cbf32cab><!--[-->`);
      ssrRenderList(quickLinks, (item) => {
        _push(`<a${ssrRenderAttr("href", item.link)} class="link-card" data-v-cbf32cab><div data-v-cbf32cab><h3 data-v-cbf32cab>${ssrInterpolate(item.title)}</h3><p data-v-cbf32cab>${ssrInterpolate(item.desc)}</p></div><span data-v-cbf32cab>Open</span></a>`);
      });
      _push(`<!--]--></div></section><footer class="home-footer" data-v-cbf32cab><p data-v-cbf32cab>© ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} Platform</p></footer></div>`);
    };
  }
});
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: { "is-home": isHome.value }
      }, _attrs))}>`);
      _push(ssrRenderComponent(unref(Layout2), null, createSlots({
        "nav-bar-content-after": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(AiChat, null, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(AiChat)
            ];
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/ArchDiagram.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
