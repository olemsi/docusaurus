...
Use this page if you need the Netherlands-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in the Netherlands lets the customer pay from a Dutch bank account in EUR through the bank or provider flow instead of entering card data.
...
- the Netherlands Open Banking method is enabled for your project
...
The Netherlands Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/netherlands/sale/list
```
