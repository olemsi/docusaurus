...
| Конечная точка | `/v2/payment/wallet/grabpay/sale` |
...
| --- | --- |
| Формат тела запроса | JSON |
| Конечная точка | `/v2/payment/wallet/grabpay/payout` |
| Полная спецификация конечной точки |  |
...
| **Особенности**ru_pm_coinsph.ditaru_pm_gcash.ditaru_pm_grabpay.ditaru_pm_paymaya.ditaВ некоторых случаях проведение выплаты пользователю может быть доступно только после того, как этот пользователь совершит отплату с использованием одного из следующих платежных методов:,,,. Актуальность данной особенности для вас уточняйте у курирующего менеджера в Some Platform. |  |
...
| **Регионы использования** | country_MY, country_PH |
| --- | --- |
| **Валюты оплаты** | references/ru/currencies/MYR.ditareferences/ru/currencies/PHP.dita, |
| **Суммы платежей** | Информацию уточняйте у курирующего менеджера Some Platform. Также вы можете уточнить в Dashboard минимальную и максимальную сумму платежа, доступную в вашем проекте. |
| **Время проведения платежа** | Информацию уточняйте у курирующего менеджера Some Platform. |
| **Конвертация валют** | На стороне Some Platform |
| **Возврат** |  |
...
| --- | --- |
| Регионы использования | country_MY, country_PH |
| Валюты платежей | references/ru/currencies/MYR.ditareferences/ru/currencies/PHP.dita, |
| Суммы платежей | Информацию уточняйте у курирующего менеджера Some Platform. Также вы можете уточнить в Dashboard минимальную и максимальную сумму платежа, доступную в вашем проекте. |
| Время проведения платежа | Информацию уточняйте у курирующего менеджера Some Platform. |
| Конвертация валют | На стороне Some Platform |
| Оплата |  |
