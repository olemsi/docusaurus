...
| **Особенности**По требованию provider_service, пользователю необходимо ввести свои данные после редиректа в сервис provider_service.Открытие страницы оплаты доступно только в режиме iframe.Платеж отклоняется, если пользователь не совершит оплату в течение 3 часов с момента его перенаправления в сервис provider_service. |  |
