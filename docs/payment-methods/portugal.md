...
Use this page if you need the Portugal-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in Portugal lets the customer pay from a Portuguese bank account in EUR through the bank or provider flow instead of entering card data.
...
- the Portugal Open Banking method is enabled for your project
...
Portugal Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/portugal/sale/list
```
