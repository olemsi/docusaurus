...
Use this page if you need the Lithuania-specific variant of Open Banking and want the shortest path to a working integration.

## What this method is

Open Banking in Lithuania lets the customer pay from a Lithuanian bank account in EUR through the bank or provider flow instead of entering card data.
...
- the Lithuania Open Banking method is enabled for your project
...
Lithuania Open Banking requires a bank selection step.
...
```text
POST /v2/info/banks/lithuania/sale/list
```
...
| Bank | ID |
| --- | --- |
| Lietuvos centrine kredito unija (LCKU) | 2081 |
| NEO Finance, AB | 2071 |
| Siauliu bankas AB | 2061 |
| Luminor (Nordea) | 2051 |
| Luminor (DNB) | 2041 |
| Citadele | 2031 |
| SEB Bank | 2021 |
