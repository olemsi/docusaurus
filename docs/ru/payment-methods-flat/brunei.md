...
| Конечная точка | `v2/payment/banks/brunei/payout` |
...
| accounttype_object type_strictly_required | numbertype_string type_strictly_required | `12345678`Пример:Номер счета пользователя. |
| bank_idtype_integer type_strictly_required | ru_pm_brunei_banks_payout_banks.dita`84212`Пример:Идентификатор банка пользователя. Подробнее о том, как получить список поддерживаемых банков см.. |  |
...
| Банк | Идентификатор |
| --- | --- |
| BAIDURI - Baiduri Bank Berhad | 84212 |
| BIBD - Bank Islam Brunei Darussalam | 84222 |
| TAIB - Perbadanan Tabung Amanah Islam Brunei | 84232 |

---

## Banks of Brunei -Выплата
...
| **Особенности**references/ru/currencies/BND.ditaВ качестве валюты оплаты можно использовать только. |  |
...
| Тип платежного метода | Платежи с использованием токена |
| --- | --- |
| Регионы использования |  |
