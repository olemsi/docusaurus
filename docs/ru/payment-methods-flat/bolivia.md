...
| Конечная точка | `v2/payment/bank-transfer/bolivia-qr/sale` |
...
| phonetype_strictly_required✱type_string | `5911234567`Пример:Номер телефона пользователя. |  |
...
- type— тип элемента;
- title— название передаваемых данных;
