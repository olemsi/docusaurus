...
| Конечная точка | `/v2/payment/wallet/dana/sale` |
...
| accounttype_strictly_required✱type_object | numbertype_strictly_required✱type_string | `123456789012`Пример:Номер телефона пользователя. |
...
ru_pm_dana_gate_purchase_redirect.ditaПодробная информация о проведении оплаты с использованием метода title через Gate представлена в разделе.
...
| --- | --- |
| Формат тела запроса | JSON |
| Конечная точка | `/v2/payment/wallet/dana/payout` |
| Полная спецификация конечной точки |  |
...
| customer_account_numbertype_required✱type_string | `123456789012`Пример:Номер телефона пользователя. |
...
ru_pm_dana_pp_purchase_redirect.ditaПодробная информация о проведении оплаты с использованием метода title через Payment Widget представлена в разделе.
